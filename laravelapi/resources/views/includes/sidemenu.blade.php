        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <img src="{!! @$site_logo->value !== '' ? url("storage/setting/".@$site_logo->value) : url('storage/setting/default.png') !!}" alt="image" class="rounded-circle" height="60px" width="60px">
                ...
                <div class="logo-element">
                    <img alt="image" class="rounded-circle" height="60px" width="60px" src="{!! @$site_logo->value !== '' ? url("storage/setting/".@$site_logo->value) : url('storage/setting/default.png') !!}">
                </div>
            </li>
